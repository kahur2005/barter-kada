export const listing = {
  id: '10000000-0000-4000-8000-000000000001', title: 'Kursi kayu bekas', description: 'Kursi kayu untuk meja belajar, masih kokoh.',
  modes: ['sale', 'barter'], fulfillment: 'ready_stock', category: 'home',
  condition: 'Bekas, layak pakai', defects: 'Goresan kecil pada sandaran.',
