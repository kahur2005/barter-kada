...
export function LoadingRows() { return <div role="status" aria-label="Memuat penawaran" aria-busy="true" className="skeleton-list">{[1, 2, 3].map(id => <div className="skeleton-row" key={id}><span /><div><i /><i /></div></div>)}</div>; }
