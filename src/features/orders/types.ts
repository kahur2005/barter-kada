...
export type OrderRoom = {
  ...
  payments: OrderPayment[]; fulfillment: { processingAt: string | null; readyAt: string | null; handedAt: string | null; receivedAt: string | null }; cancellationReason: string | null; updatedAt: string;
};
