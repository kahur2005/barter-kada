...
export type FollowUpKind = 'return_goods';
export const adminReportSchema = z.object({
  ...
  decision: z.object({ outcome: z.string(), rationale: z.string(), decidedAt: z.string().datetime(), adminName: z.string().nullable().optional(), actionUserId: z.string().uuid().nullable().optional(), followUpKind: z.literal('return_goods').nullable().optional(), followUpDueAt: z.string().datetime().nullable().optional() }).nullable(),
