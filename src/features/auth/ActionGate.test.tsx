...
function onboarding(nextStep: OnboardingState['nextStep']): OnboardingGateway {
  return { getState: vi.fn().mockResolvedValue({ nextStep, displayName: 'Rina', bio: null, areaId: nextStep === 'profile' ? null : 'depok', address: null, maskedPhone: null, phoneVerified: false }), listAreas: vi.fn().mockResolvedValue([]), completeProfile: vi.fn(), setLocation: vi.fn() };
}
