  ...
  return <>
    ...
    <div className="discovery-layout">
      ...
      <section className="results-section" aria-label={isStores ? 'Daftar toko' : 'Daftar penawaran'}>
        ...
        {areaResults.isSuccess && areaOptions.length > 0 && !areaReady && <StatusPanel title="Area pencarian tidak tersedia"><p>Area pada tautan ini sudah tidak aktif. Pilih area lain untuk melanjutkan.</p><button className="button secondary" onClick={() => setDialog('area')}>Pilih area</button></StatusPanel>}
