...
const demoPhotos = {
  ...
  jacket: 'https://images.unsplash.com/photo-1681510322309-3cfaceb80119?auto=format&fit=crop&w=1200&q=80',
  seedlings: 'https://images.unsplash.com/photo-1650223154483-ccdef5d0e19d?auto=format&fit=crop&w=1200&q=80',
  linen: 'https://images.unsplash.com/photo-1596755389378-c31d21fd1273?auto=format&fit=crop&w=1200&q=80',
  bicycle: 'https://images.unsplash.com/photo-1485965120184-e220f721d03e?auto=format&fit=crop&w=1200&q=80',
};
...
const base: PublicListing = listingSchema.parse({
  ...
  area: { id: 'depok', name: 'Beji, Depok', distanceKm: 2 }, publisher: person, images: [{ url: demoPhotos.chair, alt: 'Foto kursi kayu bekas untuk demo' }],
...
export const demoListings = [base,
  item(2, { title: 'Nasi kotak untuk Jumat bersama', description: 'Nasi hangat, lauk pilihan, sayur dan sambal terpisah. Pesan beberapa varian untuk acara keluarga atau makan siang kantor.', category: 'food', modes: ['sale'], fulfillment: 'preorder', priceMin: '10000', priceMax: '15000', unit: 'pcs', negotiable: false, barterPreferences: null, condition: 'Dibuat sesuai pesanan', defects: 'Informasikan alergi makanan melalui chat sebelum menyepakati pesanan.', publisher: foodPublisher, images: [{ url: demoPhotos.food, alt: 'Foto makanan untuk preorder demo' }], variants: [{ id: 'ayam', name: 'Nasi ayam', price: '15000', unit: 'pcs' }, { id: 'telur', name: 'Nasi telur', price: '10000', unit: 'pcs' }], preorder: { closesAt: '2026-09-12T11:00:00Z', availableAt: '2026-09-13T04:00:00Z', minimumQty: 10, remainingQty: 40, dpPercent: 50 }, handoverMethods: ['pickup', 'delivery'] }),
  item(3, { title: 'Jaket denim ukuran M', category: 'clothing', priceMin: null, priceMax: null, modes: ['barter'], negotiable: false, description: 'Jaket denim yang masih nyaman dipakai. Ingin ditukar dengan tas atau buku.', defects: 'Sedikit pudar di bagian lengan.', barterPreferences: 'Tas kanvas atau buku fiksi, boleh tawarkan yang lain.', images: [{ url: demoPhotos.jacket, alt: 'Foto jaket denim untuk barter demo' }] }),
  item(4, { title: 'Bibit cabai dari kebun rumah', category: 'garden', priceMin: '0', priceMax: '0', modes: ['free'], negotiable: false, description: 'Ada beberapa bibit cabai siap dipindah ke pot. Silakan hubungi untuk menyepakati jumlah dan pengambilan.', condition: 'Bibit hidup', defects: 'Ukuran bibit tidak semuanya sama.', barterPreferences: null, area: { id: 'depok', name: 'Kukusan, Depok', distanceKm: 1 }, images: [{ url: demoPhotos.seedlings, alt: 'Foto bibit cabai untuk demo' }] }),
  item(5, { title: 'Kemeja linen warna natural', category: 'clothing', priceMin: '75000', priceMax: '75000', modes: ['sale'], publisher: { ...person, id: demoStores[1].id, name: 'Lemari Kedua', storeSlug: 'lemari-kedua' }, description: 'Kemeja linen ukuran L. Sudah dicuci dan siap digunakan kembali.', defects: 'Warna sedikit memudar setelah dicuci.', barterPreferences: null, images: [{ url: demoPhotos.linen, alt: 'Foto kemeja linen untuk demo' }] }),
  item(6, { title: 'Sepeda kota untuk perjalanan dekat', category: 'vehicles', priceMin: '850000', priceMax: '850000', modes: ['sale', 'barter'], description: 'Sepeda untuk perjalanan santai di sekitar rumah. Rem berfungsi, silakan periksa langsung saat bertemu.', defects: 'Ban belakang mulai aus.', barterPreferences: 'Sepeda lipat, tambahan uang bisa dibahas.', images: [{ url: demoPhotos.bicycle, alt: 'Foto sepeda kota untuk jual atau barter demo' }], area: { id: 'depok', name: 'Pancoran Mas, Depok', distanceKm: 4 } }),
  item(7, { title: 'Catering rumahan untuk acara kecil', category: 'food', fulfillment: 'catering', modes: ['sale'], priceMin: '25000', priceMax: '25000', unit: 'paket', publisher: foodPublisher, condition: 'Dibuat sesuai pesanan', defects: 'Konfirmasi alergi dan kebutuhan khusus terlebih dahulu.', barterPreferences: null, description: 'Menu rumahan dengan pilihan lauk dan sayur. Cocok untuk arisan atau acara keluarga. Jadwal dan kapasitas dikonfirmasi melalui chat.', images: [{ url: demoPhotos.food, alt: 'Foto menu catering untuk demo' }], catering: { minimumQty: 15, leadTimeHours: 48, serviceAreas: ['Depok', 'Jakarta Selatan'], notes: 'Menu dan tanggal dapat dibahas sebelum penjual membuat ringkasan pesanan.' } }),
];
